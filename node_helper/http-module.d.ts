...
import { RequestOptions as RequestOptionsHttp, IncomingHttpHeaders } from 'http';
import { RequestOptions as RequestOptionsHttps } from 'https';
import { URL } from 'url';
export declare type HTTPModuleRequestOptions = RequestOptionsHttp | RequestOptionsHttps | string | URL;
/**
